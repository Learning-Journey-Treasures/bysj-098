# 1.项目介绍
- 系统角色：管理员、农户
- 功能模块：学生管理、教师管理、课程分类管理、课程信息管理、选课信息管理、系统管理等
...
- 配置tomcat，启动项目，其中，我将deployment下的application contex配置为 /ssmdmkas
- http://localhost:8080/ssmdmkas/admin/dist/index.html   管理员账号密码：abo/abo， 其他自行查表
